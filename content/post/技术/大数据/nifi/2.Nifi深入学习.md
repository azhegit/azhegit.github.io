...
- 技术
- 大数据
date: '2024-07-15 13:12:40+08:00'
tags:
- nifi
...
1. **创建 GenerateFlowFile 并设置大小**
   ...
   ![设置GenerateFlowFile大小](https://www.azheimage.top/设置GenerateFlowFile大小.gif)
2. **配置 FlowFile**

   ![设置GenerateFlowFile定时](https://www.azheimage.top/设置GenerateFlowFile定时.gif)

3. **创建 ReplaceText 并连接**

   ![创建连接ReplaceText](https://www.azheimage.top/创建连接ReplaceText.gif)

4. **启动 GenerateFile**

   ![启动GenerateFlowFile](https://www.azheimage.top/启动GenerateFlowFile.gif)

5. **配置 ReplaceText**

![配置ReplaceText](https://www.azheimage.top/配置ReplaceText.gif)

**6.创建 PutFile**

停止 GenerateFlowFile，然后创建 PutFile。

![创建PutFile](https://www.azheimage.top/创建PutFile.gif)
...
![启动CsvToJson](https://www.azheimage.top/启动CsvToJson.gif)
...
![img](https://www.azheimage.top/processor-connection-bubble.8828c836.png)
...
![img](https://www.azheimage.top/nifi-connection-menu.6a39f3e8.png)
...
![img](https://www.azheimage.top/nifi-connection-bend-points.6444d204.png)

### 操作

​ 修改第二个处理器：ReplaceText，Replacement Value 改为【a,b,c】，这样便不会被下一个 ExtractText 处理器所捕获。

![修改失败配置](https://www.azheimage.top/修改配置以使失败.gif)

​ 启动处理器观察数据流向

![错误数据流向](https://www.azheimage.top/错误数据流向.gif)

将未匹配到的 FlowFile 发送到 LogAttribute 组件，观察流向

![未匹配数据流向](https://www.azheimage.top/未匹配数据流向.gif)

修改 ReplaceText 的 Replacement Value 改为【a,b,c,d】

![匹配数据流向](https://www.azheimage.top/匹配数据流向.gif)
